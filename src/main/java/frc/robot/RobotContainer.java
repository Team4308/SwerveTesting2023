...
public class RobotContainer
{
  ...
  private void configureBindings()
  {
    ...
    stick.Start.onTrue((new InstantCommand(drivebase::zeroGyro)));
//    new JoystickButton(driverXbox, 3).onTrue(new InstantCommand(drivebase::addFakeVisionReading));
    stick.Back.whileTrue(new RepeatCommand(new InstantCommand(drivebase::lock, drivebase)));
    stick.LB.onTrue(new InstantCommand(drivebase::speaker));
    stick.RB.onTrue(new InstantCommand(drivebase::amp));
  }
